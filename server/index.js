...
async function routeLead(lead, widget) {
  ...
  if (type === 'email' && config.email) {
    ...
    await sendEmail({
      ...
      html: `
        <h2 style="font-family:sans-serif;color:#7B4F00">New Lead — ${widget.config?.clinicName || 'Your Clinic'}</h2>
    ...
    await sendEmail({
      ...
      html: `
        <div style="font-family:sans-serif;max-width:520px;margin:0 auto">
          <h2 style="color:#7B4F00">Hi ${lead.fname},</h2>
          ...
          <div style="background:#FDF3CD;border-radius:12px;padding:16px 20px;margin:20px 0">
            <p style="color:#7B4F00;font-size:13px;line-height:1.7">${lead.analysis}</p>
          </div>
          ...
          <p style="color:#555;margin-top:24px">We look forward to seeing you in person. <a href="${widget.config?.bookingUrl || '#'}" style="color:#B8860B;font-weight:600">Book your consultation →</a></p>
